...
const DevelopmentZipVersionFolder = '../../../vu-project-development-latest-version/vu.project.localhost.com';
const DevelopmentZipFileSource = '../../../vu-project-development-latest-version';
const ProductionZipVersionFolder = '../../../vu-project-production-latest-version/vu.project.localhost.com';
const ProductionZipFileSource = '../../../vu-project-production-latest-version';

export default defineConfig({

  favicons: [
    '/vu-project-favicon.png',
  ],
  ...
  define: {
    ...
    // API_USER_NAME: window.wp_ech.api.username,
    // API_PASSWORD: window.wp_ech.api.password,

    // API_USER_NAME: 'test-customer-04',
    // API_PASSWORD: '3UEE WMNN erq4 Nz9q SkyO aon5',

    // API_USER_NAME: 'test-customer-33',
    // API_PASSWORD: '0t7k 76L5 cGY3 IlmY TFjs KiUG',

    // API_USER_NAME: 'test-customer-04-sm-10',
    // API_PASSWORD: 'w40H mY0Z 4cd5 esxe klbi vutQ',

    API_USER_NAME: 'admin',
    API_PASSWORD: 'uqT1 P8Cb KtzM Z1VL xMla ccNt',

    // API_USER_NAME: 'test-customer-33-su-01',
    // API_PASSWORD: 'NlQX 6GhT D7B1 wMYG 0mBF Z66A',
          ...
          events:{
            ...
            onEnd:{
              ...
              copy:[
                ...
                { source: '../../Ejaz-Reserch.md', destination: DevelopmentZipVersionFolder+'/Ejaz-Reserch.md' },
