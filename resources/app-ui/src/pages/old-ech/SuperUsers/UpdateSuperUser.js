...
import SuperUsersScreenEditVideoIframe from "@/components/VideoTutorialsIframes/SuperAdminIframes/SuperUsersScreenEditVideoIframe";
...
const UpdateSuperUser = () => {
    ...
    const [superUsersEditVideoTutorials, setSuperUsersEditVideoTutorials] = useState({});
    const [superUsersEditVideoTutorialModelOpen, setSuperUsersEditVideoTutorialModelOpen] = useState(false);
    /**
     * End By Mairaj
     */
    ...
    if (updateSuperUserSkeleton) {
        ...
        return (
            <PageContainer>
                    ...
                    <FloatButton
                        ...
                        onClick={ ()=> {
                            ...
                            request('/wp/v2/super-admin-video-tutorials', {
                                ...
                                const super_users_screen_edit_video_tutorials_data = {
                                    ...initialValues,
                                    super_users_screen: {
                                ...
                                setSuperUsersEditVideoTutorials(super_users_screen_edit_video_tutorials_data);

                                console.log('super_users_screen_edit_video_tutorials_data');
                                console.log(super_users_screen_edit_video_tutorials_data);

                            });
                            setSuperUsersEditVideoTutorialModelOpen(true);
                        }}
                    />
                    <FloatButton
                ...
                <ModalForm
                    title={'Super User Edit Video Tutorial'}
                    open={superUsersEditVideoTutorialModelOpen}
                    onOpenChange={setSuperUsersEditVideoTutorialModelOpen}
                    modalProps={{
                        destroyOnClose: true,
                ...
                >
                    <VideoTutorialIframe
                        iframeUrl={superUsersEditVideoTutorials?.super_users_screen?.edit_video_url}
                    />
