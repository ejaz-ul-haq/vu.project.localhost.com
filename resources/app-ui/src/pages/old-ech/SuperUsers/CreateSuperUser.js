...
import {Row, Col, Space, message, Button, Form, DatePicker, Image, Skeleton, FloatButton} from 'antd';
import {
...
import SuperUsersScreenCreateVideoIframe from "@/components/VideoTutorialsIframes/SuperAdminIframes/SuperUsersScreenCreateVideoIframe";
    ...
    try {
        createUser(
            ...
            if (api_response?.id > 0) {
                ...
                history.push('/super-users/edit/' + api_response?.id);
            }
        });
    } catch (api_response) {
...
const CreateSuperUser = () => {
    ...
    const [superUsersCreateVideoTutorials, setSuperUsersCreateVideoTutorials] = useState({});
    const [superUsersCreateVideoTutorialModelOpen, setSuperUsersCreateVideoTutorialModelOpen] = useState(false);
    /**
     * End By Mairaj
     */
    ...
    if (createSuperUserSkeleton) {
        ...
        return (
            <PageContainer>
                    ...
                    <FloatButton
                        ...
                        onClick={ ()=> {
                            ...
                            request('/wp/v2/super-admin-video-tutorials', {
                                ...
                                const super_users_screen_create_video_tutorials_data = {
                                    ...initialValues,
                                    super_users_screen: {
                                ...
                                setSuperUsersCreateVideoTutorials(super_users_screen_create_video_tutorials_data);

                                console.log('super_users_screen_create_video_tutorials_data');
                                console.log(super_users_screen_create_video_tutorials_data);

                            });
                            setSuperUsersCreateVideoTutorialModelOpen(true);
                        }}
                    />
                    <FloatButton
                ...
                <ModalForm
                    title={'Super User Create Video Tutorial'}
                    open={superUsersCreateVideoTutorialModelOpen}
                    onOpenChange={setSuperUsersCreateVideoTutorialModelOpen}
                    modalProps={{
                        destroyOnClose: true,
                ...
                >
                    <VideoTutorialIframe
                        iframeUrl={superUsersCreateVideoTutorials?.super_users_screen?.create_video_url}
                    />
