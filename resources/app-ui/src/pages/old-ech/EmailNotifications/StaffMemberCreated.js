    ...
    if (staffMemberCreatedSkeleton) {
        ...
        return (
            <PageContainer>
                    ...
                    <FloatButton
                        ...
                        onClick={() => {
                            ...
                            request('/wp/v2/super-admin-video-tutorials', {
                                ...
                                const email_notifications_screen_staff_member_created_video_tutorials_data = {
                                    ...initialValues,
                                ...
                                setEmailNotificationsStaffMemberCreatedVideoTutorials(email_notifications_screen_staff_member_created_video_tutorials_data);

                                console.log('email_notifications_screen_staff_member_created_video_tutorials_data');
                                console.log(email_notifications_screen_staff_member_created_video_tutorials_data);

                            });
                            setEmailNotificationsStaffMemberCreatedVideoTutorialModelOpen(true);
                        }}
                    />
                    <FloatButton
                ...
                <ModalForm
                    title={'Email Notifications Staff Member Created Video Tutorial'}
                    open={emailNotificationsStaffMemberCreatedVideoTutorialModelOpen}
                    onOpenChange={setEmailNotificationsStaffMemberCreatedVideoTutorialModelOpen}
                    modalProps={{
                        destroyOnClose: true,
                ...
                >
                    <VideoTutorialIframe
                        iframeUrl={emailNotificationsStaffMemberCreatedVideoTutorials?.email_notifications_screen?.staff_member_created_video_url}
                    />
