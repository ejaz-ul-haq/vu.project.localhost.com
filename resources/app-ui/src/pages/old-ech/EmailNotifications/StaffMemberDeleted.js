...
import EmailNotificationsScreenStaffMemberDeletedVideoIframe from "@/components/VideoTutorialsIframes/SuperAdminIframes/EmailNotificationsScreenStaffMemberDeletedVideoIframe";
import StaffMemberDeletedSkeleton from "@/components/Skeleton/EmailNotifications/StaffMemberDeletedSkeleton";
...
const StaffMemberDeleted = ( { status, subject, body } ) => {
  ...
  const [emailNotificationId, setEmailNotificationId] = useState('staff_member_deleted');
  const [staffMemberDeletedData, setStaffMemberDeletedData] = useState({});
  const [staffMemberDeletedSkeleton, setStaffMemberDeletedSkeleton] = useState(true);
  ...
  const [emailNotificationsStaffMemberDeletedVideoTutorials, setEmailNotificationsStaffMemberDeletedVideoTutorials] = useState({});
  const [emailNotificationsStaffMemberDeletedVideoTutorialModelOpen, setEmailNotificationsStaffMemberDeletedVideoTutorialModelOpen] = useState(false);
  /**
   * End By Mairaj
   */
  ...
  useEffect(() => {
    ...
    request('/wp/v2/email-notification/?organization_id='+organizationId+'&email_notification_id='+emailNotificationId, {
      ...
      setStaffMemberDeletedData(api_response);

      setStaffMemberDeletedSkeleton(false);
   ...
   */
  useEffect(() => {
    form.setFieldValue('status', staffMemberDeletedData?.status);
    form.setFieldValue('subject', staffMemberDeletedData?.subject);
    form.setFieldValue('body', staffMemberDeletedData?.body);

    if (staffMemberDeletedData?.status === true) {
  ...
  //
  //
  // console.log('staff-member-deleted - subject');
  // console.log(subject);
        ...
        <PageContainer>
          <ProForm
              ...
              onFinish={async (values) => {
                ...
                values.email_notification_id = 'staff_member_deleted';
            ...
            <FloatButton
                ...
                onClick={() => {
                  ...
                  request('/wp/v2/super-admin-video-tutorials', {
                    ...
                    const email_notifications_screen_staff_member_deleted_video_tutorials_data = {
                      ...initialValues,
                    ...
                    setEmailNotificationsStaffMemberDeletedVideoTutorials(email_notifications_screen_staff_member_deleted_video_tutorials_data);

                    console.log('email_notifications_screen_staff_member_deleted_video_tutorials_data');
                    console.log(email_notifications_screen_staff_member_deleted_video_tutorials_data);

                  });
                  setEmailNotificationsStaffMemberDeletedVideoTutorialModelOpen(true);
                }}
            />
            <FloatButton
          ...
          <ModalForm
              title={'Email Notifications Staff Member Deleted Video Tutorial'}
              open={emailNotificationsStaffMemberDeletedVideoTutorialModelOpen}
              onOpenChange={setEmailNotificationsStaffMemberDeletedVideoTutorialModelOpen}
              modalProps={{
                destroyOnClose: true,
          ...
          >
            <VideoTutorialIframe
                iframeUrl={emailNotificationsStaffMemberDeletedVideoTutorials?.email_notifications_screen?.staff_member_deleted_video_url}
            />
...
export default StaffMemberDeleted;
...
//
//
// export default React.memo(StaffMemberDeleted, areEqual)



// const StaffMemberDeleted = () => {
//     return(
//         <>
