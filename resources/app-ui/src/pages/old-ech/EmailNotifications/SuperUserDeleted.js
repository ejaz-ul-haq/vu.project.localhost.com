    ...
    if (superUserDeletedSkeleton) {
        ...
        return (
            <PageContainer>
                    ...
                    <FloatButton
                        ...
                        onClick={() => {
                            ...
                            request('/wp/v2/super-admin-video-tutorials', {
                                ...
                                const email_notifications_screen_super_user_deleted_video_tutorials_data = {
                                    ...initialValues,
                                ...
                                setEmailNotificationsSuperUserDeletedVideoTutorials(email_notifications_screen_super_user_deleted_video_tutorials_data);

                                console.log('email_notifications_screen_super_user_deleted_video_tutorials_data');
                                console.log(email_notifications_screen_super_user_deleted_video_tutorials_data);

                            });
                            setEmailNotificationsSuperUserDeletedVideoTutorialModelOpen(true);
                        }}
                    />
                    <FloatButton
                ...
                <ModalForm
                    title={'Email Notifications Super User Deleted Video Tutorial'}
                    open={emailNotificationsSuperUserDeletedVideoTutorialModelOpen}
                    onOpenChange={setEmailNotificationsSuperUserDeletedVideoTutorialModelOpen}
                    modalProps={{
                        destroyOnClose: true,
                ...
                >
                    <VideoTutorialIframe
                        iframeUrl={emailNotificationsSuperUserDeletedVideoTutorials?.email_notifications_screen?.super_user_deleted_video_url}
                    />
