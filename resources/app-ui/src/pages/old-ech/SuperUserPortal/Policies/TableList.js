...
import PoliciesScreenListingVideoIframe from "@/components/VideoTutorialsIframes/SuperUserIframes/PoliciesScreenListingVideoIframe";
...
const TableList = () => {
  ...
  const items = [
    ...
    /**
     * Start Comment By Mairaj 9-10-2023
     */
    // {
    //   label: 'Edit Policy',
    //   key: 'editable',
    ...
    /**
     * End Comment By Mairaj 9-10-2023
     */
  ];
        ...
        <Space key={'space-row-actions-' + record.id} wrap>
          <Dropdown.Button key={'row-actions-' + record.id} menu={{items, onClick: ({ key }) => {
              ...
              if (key === 'view') {
                ...
                history.push('/super-user/policies/view/' + record.id + '/' + organizationId);
              }
              ...
              //   console.log(record);
              //
              //   history.push('/super-user/policies/edit/' + record.id + '/' + organizationId);
              //
              // }
