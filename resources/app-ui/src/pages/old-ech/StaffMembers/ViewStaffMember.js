...
import {Row, Col, Space, message, Button, Form, DatePicker, Typography, Avatar, Image} from 'antd';
...
//       return msg;
//     } catch (error) {
//       console.log('viewStaffMember - error');
//       console.log(error);
...
//   };
//
//   const staffMemberViewed = viewStaffMember();
//   console.log('staffMemberViewed');
//   console.log(staffMemberViewed);
//
// };
                ...
                staff_member: {
                  ...
                  step_01: {
                    ...
                    bio_details: {
                      ...
                      staff_member_profile_image: api_response?.data?.ech_user_profile_image_url,
        ...
        >
          ...
          >
            ...
            <ProForm.Group size={24}>
              ...
              {/*    <Avatar size={150} src={user?.meta?.ech_user_profile_image_url} />*/}
