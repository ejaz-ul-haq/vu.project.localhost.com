import {
  ...
  ProFormRadio,
  ProFormSegmented,
  ProFormTextArea, ProFormSwitch, ModalForm, ProTable,
} from '@ant-design/pro-components';
import {Row, Col, Space, message, Button, Form, DatePicker, Image, FloatButton, Avatar, Dropdown, Badge, Tag} from 'antd';
import {
  BellOutlined,
...
import ActiveStaffMembersScreenEditVideoIframe from "@/components/VideoTutorialsIframes/SuperAdminIframes/ActiveStaffMembersScreenEditVideoIframe";
...
const UpdateStaffMember = () => {
  ...
  const courses_table_columns = [
    ...
    },
    {
      ...
      key: 'table-column-course-title',
      hideInSearch: true,
    },
    {
      title: "Status",
      dataIndex: 'course_progress_status',
      key: 'table-column-course-progress-status',
      hideInSearch: true,
      // render: (date) => {
    ...
    },
    {
      ...
      dataIndex: 'course_started',
      key: 'table-column-course-started',
      hideInSearch: true,
    },
    {
      title: "Course Completed",
      dataIndex: 'course_completed',
      key: 'table-column-course-completed',
      hideInSearch: true,
    },

    // {
    //   title: "Certificate",
    //   dataIndex: 'course_certificate_url',
    //   key: 'table-column-course-certificate-url',
    //   hideInSearch: true,
    ...
    //           key="a"
    //           // onClick={() => {
    //           //   history.push(record.course_certificate_url);
    //           // }}
    //           href={record.course_certificate_url}
    //           target='_blank'
    //       >
    //         Certificate URL
    //       </a>,
    //     ];
    //     if( '' != record.course_certificate_url ){
          ...
          <ProTable
              ...
              request={
                ...
                async (params = {}, sort, filter, paginate) => {
                  ...
                  return await request('/wp/v2/user-courses', {
                    method: 'POST',
                    data: {
                        user_id: userId
                      },
