...
import ActiveStaffMembersScreenCreateVideoIframe from "@/components/VideoTutorialsIframes/SuperAdminIframes/ActiveStaffMembersScreenCreateVideoIframe";
  ...
  try {
    createUser(
      ...
      if (api_response?.id > 0) {
        ...
        history.push('/staff-members/edit/' + api_response?.id);
      }
    });
  } catch (api_response) {
