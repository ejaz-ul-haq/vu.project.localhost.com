...
import {EditOutlined, EyeOutlined, PlusOutlined, SettingOutlined, MenuUnfoldOutlined, UserOutlined} from '@ant-design/icons';
        ...
        <Space key={'space-row-actions-' + record.id} wrap>
          <Dropdown.Button key={'row-actions-' + record.id} menu={{items, onClick: ({ key }) => {
              ...
              if (key === 'view') {
                ...
                history.push('/administrator/policies/view/' + record.id);
              }
              ...
              if (key === 'editable') {
                ...
                history.push('/administrator/policies/edit/' + record.id);
        ...
        toolBarRender={() => [
          <Button
            ...
            onClick={() => {
              ...
              history.push('/administrator/policies/new');
            }}
          >
