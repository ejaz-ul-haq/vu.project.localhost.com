...
import {DownloadOutlined, CodeOutlined, ReadOutlined, PlusOutlined} from "@ant-design/icons";
    ...
    <PageContainer
      header={{
        ...
        extra: [
          ...
          >
              <PlusOutlined/> <FormattedMessage id="pages.updatedPolicy.new" defaultMessage="New"/>
          </Button>,
          <Button
            key="1"
            onClick={() => {
