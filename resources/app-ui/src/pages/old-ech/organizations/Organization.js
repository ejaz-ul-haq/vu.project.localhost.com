...
import OrganizationScreenOrganizationVideoIframe from "@/components/VideoTutorialsIframes/SuperAdminIframes/OrganizationScreenOrganizationVideoIframe";
...
const Organization = () => {
    ...
    const [organizationVideoTutorials, setOrganizationVideoTutorials] = useState({});
    const [organizationVideoTutorialModelOpen, setOrganizationVideoTutorialModelOpen] = useState(false);
    /**
     * End By Mairaj
     */
    ...
    useEffect(() => {
        ...
        getEchOrganization(
            {
                context: 'edit',
                id: initialState?.currentUser?.meta?.ech_organization_id,
            },
            {getResponse: true}
        ).then((api_response) => {
    ...
    if (multiStepsFormSkeletonStatus) {
        ...
        return (
            ...
            >
                    ...
                    <FloatButton
                        ...
                        onClick={ ()=> {
                            ...
                            request('/wp/v2/super-admin-video-tutorials', {
                                ...
                                const organization_screen_video_tutorials_data = {
                                    ...initialValues,
                                    organization_screen: {
                                ...
                                setOrganizationVideoTutorials(organization_screen_video_tutorials_data);

                                console.log('organization_screen_video_tutorials_data');
                                console.log(organization_screen_video_tutorials_data);

                            });
                            setOrganizationVideoTutorialModelOpen(true);
                        }}
                    />
                    <FloatButton
                ...
                <ModalForm
                    title={'Organisation Video Tutorial'}
                    open={organizationVideoTutorialModelOpen}
                    onOpenChange={setOrganizationVideoTutorialModelOpen}
                    modalProps={{
                        destroyOnClose: true,
                ...
                >
                    <VideoTutorialIframe
                        iframeUrl={organizationVideoTutorials?.organization_screen?.organization_video_url}
                    />
