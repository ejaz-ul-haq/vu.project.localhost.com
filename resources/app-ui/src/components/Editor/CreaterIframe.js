...
const CreaterIframe = (props) => {
    ...
    const {iframeUrlPostID} = props;
    const iframeUrl = `${SITE_URL}/wp-admin/post-new.php?post_type=ech-policy&ech-iframe-type=ech-frontend-editor`;
