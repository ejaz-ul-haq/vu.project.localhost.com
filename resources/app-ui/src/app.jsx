...
export async function getInitialState() {
  ...
  const {location, action} = history;
    ...
    return {
        ...
        // isSuperUser: current_user?.roles.includes('ech_super_user'),
        // isStaffMember: current_user?.roles.includes('ech_staff_member'),
        settings: defaultSettings,
        // ech_settings: general_settings
    }
...
export const layout = ({initialState, setInitialState}) => {
  ...
  console.log(layout_type);
    ...
    const site_layout = {
        ...
        //       style={{ fontSize: '18px' }}
        //       onClick={() => { window.open(initialState?.ech_settings[initialState?.ech_settings.findIndex(ech_setting_row => ech_setting_row.key === 'social_icon_facebook_url') ]?.value) }}
        //     />,
        //     <TwitterOutlined
        //       key="TwitterOutlined"
        //       style={{ fontSize: '18px' }}
        //       onClick={() => { window.open(initialState?.ech_settings[initialState?.ech_settings.findIndex(ech_setting_row => ech_setting_row.key === 'social_icon_twitter_url') ]?.value) }}
        //     />,
        //     <LinkedinOutlined
        //       key="LinkedinOutlined"
        //       style={{ fontSize: '18px' }}
        //       onClick={() => { window.open(initialState?.ech_settings[initialState?.ech_settings.findIndex(ech_setting_row => ech_setting_row.key === 'social_icon_linkedin_url') ]?.value) }}
        //     />,
        //     <YoutubeOutlined
        //       key="YoutubeOutlined"
        //       style={{ fontSize: '18px' }}
        //       onClick={() => { window.open(initialState?.ech_settings[initialState?.ech_settings.findIndex(ech_setting_row => ech_setting_row.key === 'social_icon_youtube_url') ]?.value) }}
        //     />,
        //   ];
        //   return social_icons;
        // },
     ...
     const app_layout = {
       ...
       menuDataRender: ( MenuDataItems ) => {
        ...
        links: [
            ...
            <a key="produced-by-ejazulhaq" rel="noopener noreferrer">
                <GlobalOutlined />
                <span>Produced By Ejaz Ul Haq</span>
            </a>,
        ],
        childrenRender: (children) => {
            return (
