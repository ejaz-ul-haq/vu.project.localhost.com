...
/** 此处后端没有提供注释 GET /wp/v2/menu-items */
export async function getNavMenuItem(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getNavMenuItemParams,
  options?: { [key: string]: any },
) {
  return request<API.navMenuItem>('/wp/v2/menu-items', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** 此处后端没有提供注释 POST /wp/v2/menu-items */
...
/** 此处后端没有提供注释 GET /wp/v2/menu-items/${param0} */
export async function getNavMenuItem_2(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getNavMenuItemParams,
  options?: { [key: string]: any },
) {
  const { id: param0, ...queryParams } = params;
  return request<API.navMenuItem>(`/wp/v2/menu-items/${param0}`, {
    method: 'GET',
    params: {
      ...queryParams,
    },
...
/** 此处后端没有提供注释 PUT /wp/v2/menu-items/${param0} */
export async function putNavMenuItem(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.putNavMenuItemParams,
  body: {
    /** The title for the object. */
    title?: { raw?: string; rendered?: string };
    /** The family of objects originally represented, such as "post_type" or "taxonomy". */
...
/** 此处后端没有提供注释 POST /wp/v2/menu-items/${param0} */
export async function createNavMenuItem_2(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.createNavMenuItemParams,
  body: {
    /** The title for the object. */
    title?: { raw?: string; rendered?: string };
    /** The family of objects originally represented, such as "post_type" or "taxonomy". */
...
/** 此处后端没有提供注释 DELETE /wp/v2/menu-items/${param0} */
export async function deleteNavMenuItem(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.deleteNavMenuItemParams,
  body: {
...
/** 此处后端没有提供注释 PATCH /wp/v2/menu-items/${param0} */
export async function patchNavMenuItem(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.patchNavMenuItemParams,
  body: {
    /** The title for the object. */
    title?: { raw?: string; rendered?: string };
    /** The family of objects originally represented, such as "post_type" or "taxonomy". */
