...
/** 此处后端没有提供注释 GET /wp/v2/ech-customer-organizations */
export async function getEchOrganizations(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getEchOrganizationsParams,
  options?: { [key: string]: any },
) {
  return request<API.echOrganization>('/wp/v2/ech-customer-organizations', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** 此处后端没有提供注释 POST /wp/v2/ech-customer-organizations */
export async function createEchOrganization(
  body: {
...
/** 此处后端没有提供注释 GET /wp/v2/ech-customer-organizations/${param0} */
export async function getEchOrganization(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getEchOrganizationParams,
  options?: { [key: string]: any },
) {
  const { id: param0, ...queryParams } = params;
  return request<API.echOrganization>(`/wp/v2/ech-customer-organizations/${param0}`, {
    method: 'GET',
    params: {
      ...queryParams,
    },
...
/** 此处后端没有提供注释 PUT /wp/v2/ech-customer-organizations/${param0} */
export async function putEchOrganization(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.putEchOrganizationParams,
  body: {
    /** The date the post was published, in the site's timezone. */
    date?: any;
    /** The date the post was published, as GMT. */
...
/** 此处后端没有提供注释 POST /wp/v2/ech-customer-organizations/${param0} */
export async function getEchOrganizationByPostMethod(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getEchOrganizationByPostMethodParams,
  body: {
    /** The date the post was published, in the site's timezone. */
    date?: any;
    /** The date the post was published, as GMT. */
...
/** 此处后端没有提供注释 DELETE /wp/v2/ech-customer-organizations/${param0} */
export async function deleteEchOrganization(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.deleteEchOrganizationParams,
  body: {
...
/** 此处后端没有提供注释 PATCH /wp/v2/ech-customer-organizations/${param0} */
export async function patchEchOrganization(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.patchEchOrganizationParams,
  body: {
    /** The date the post was published, in the site's timezone. */
    date?: any;
    /** The date the post was published, as GMT. */
